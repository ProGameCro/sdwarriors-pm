...
KillCard(from, weap, alternatewep) 
{
	...
	wait 2;
	for(i = 0; i < 25 && !isDefined(self.iswaitingforcard); i++)
		wait .1;
	for(i = 0; i < shader.size; i++) 
	{
		shader[i] MoveOverTime(.3);
...
setWeaponIcon(wep, alternate) 
{
	...
	switch(wep) 
	{
		case "destructible": s = "death_car"; x = 40;
			break;
		case "ak47": s = "weapon_ak47";
			break;
		case "ak74u": s = "weapon_aks74u";
			break;
		case "m1014": s = "hud_icon_benelli_m4";
			break;
		case "barrett": s = "weapon_barrett50cal";
			break;
		...
		case "g3": s = "weapon_g3";
			break;
		case "g36c": s = "weapon_g36c";
			break;
		case "m14": s = "weapon_m14";
			break;
		case "m21": s = "weapon_m14_scoped";
			break;
		case "m16": s = "weapon_m16a4";
			break;
		case "saw": s = "weapon_m249saw";
			break;
		case "m40a3": s = "weapon_m40a3";	
			break;
		case "m4": s = "weapon_m4carbine";
			break;
		...
		case "uzi": s = "weapon_mini_uzi";
			break;
		case "mp44": s = "weapon_mp44";
			break;
		case "mp5": s = "weapon_mp5";
			break;
		case "p90": s = "weapon_p90";
			break;
		case "remington700": s = "weapon_remington700";
			break;
		case "rpd": s = "weapon_rpd";
			break;
		case "rpg": s = "weapon_rpg7";
			break;
		case "skorpion": s = "weapon_skorpion";
			break;
		case "usp": s = "weapon_usp_45"; x = 45; y = 45;
			break;
